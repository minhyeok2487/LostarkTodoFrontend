...
const createStringInterpolator$1 = config => {
  ...
  const interpolations = outputRange[0].match(stringShapeRegex).map((_, i) => createInterpolator(_extends({}, config, {
...
export { animated$1 as animated, animated$1 as a, apply, Interpolation, useChain, useSpring, useSprings, useTrail, useTransition, config, createAnimatedInterpolation as interpolate, Controller, Spring, Trail, Transition, Globals };
